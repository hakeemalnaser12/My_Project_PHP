                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text"  name="blns" placeholder=" Price" class="checkout__input__add">
                       ...
                       <button type="submit" class="site-btn"  name="add"> Add custemar</button>
                </form>
            </div>
        </div>
    </section>
      ...
      $city = $_POST['city'];
       $addr = $_POST['address'];
        $code = $_POST['code'];
             ...
             $em = $_POST['em'];
             $pass = $_POST['pass'];
        $add = "insert into custemer (cus_fname,cus_lname,country,city,address,cus_code,cus_balance,cus_phone,cus_email,ad_pass) values ('$fname','$lname','$cont','$city','$addr','$code','$blns','$ph','$em','$pass') ";
          $rs = mysqli_query($con,$add)or die(mysqli_error($con));
          if($rs){

                 echo "<script> alert(' Successfully  add custemer');</script>";

          }else{ echo "<script> alert('failed add custemer');</script>";}
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: 60-49 taiz 11378 New York</li>
