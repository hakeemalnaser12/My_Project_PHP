                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" name="proim">
                                    </div>
                                </div>
                            </div>
                            <div class="checkout__input">
                                <p> DESCRIPTION <span>*</span></p>
                                <input type="text"  placeholder="DESCRIPTION"  name="prodd" >
                            </div>
                            <div class="checkout__input">
                                <p>Price<span>*</span></p>
                                <input type="text"  name="pro_pc" placeholder=" Price" class="checkout__input__add">
     ...
     $pimg = $_POST['proim'];
      $pdd = $_POST['prodd'];
       $pic = $_POST['pro_pc'];
        ...
        $add = "insert into products (pro_name,pro_image,PRO_PRICE,PRO_DESCRIPTION,CATE_ID) values ('$pname','$pimg','$pic','$pdd','$cat') ";
          $rs = mysqli_query($con,$add);
          if($rs){

                 echo "<script> alert(' Successfully  add prodect');</script>";

          }else{ echo "<script> alert('failed add prodect');</script>";}
