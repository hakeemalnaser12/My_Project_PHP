...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> Eng-hkeeme@colorlib.com</li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="<?php echo "img/laptop/".$roww['PRO_IMAGE']; ?>"/>
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">$<?php echo $roww['PRO_PRICE'];  ?></div>
                        <p><?php echo $roww['PRO_DESCRIPTION'];  ?>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit amet quam
                        ...
                        <div class="product__details__quantity">
                         ...
                         <div class="quantity">
                            ...
                            <style type="text/css">  #C{
                              ...
                              <input type="text" value="<?php echo $roww['PRO_ID'];  ?>" name="ID" id="C">
                        </div>
                        <input type="submit"  class="primary-btn" value="ADD TO CARD" name="cart"  />
